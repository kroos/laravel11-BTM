...
class Jabatan extends Model
{
	...
	{
		return $this->belongsToMany(\App\Models\Staff::class, 'btm_loan.dept_approval', 'kod_jabatan', 'nostaf')->using(\App\Models\DepartmentApproval::class)->withPivot( 'kod_jabatan', 'nostaf', 'active')->wherePivot('active', 1);
	}
