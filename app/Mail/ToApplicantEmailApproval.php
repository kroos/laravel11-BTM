...
class ToApplicantEmailApproval extends Mailable
{
	...
	public function envelope(): Envelope
	{
		return new Envelope(
			...
			subject: 'BTM New Email Registration Application Form : Approval Done',
		);
	}
	...
	{
		return new Content(
			markdown: 'mail.EmailApplicationFormApproval',
			with: [
