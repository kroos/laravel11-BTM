...
class ToApplicantEmailUpdate extends Mailable
{
	...
	public function envelope(): Envelope
	{
		return new Envelope(
			...
			subject: 'BTM New Email Registration Application Form : Updating Form',
		);
	}
	...
	{
		return new Content(
			markdown: 'mail.EmailApplicationFormUpdate',
			with: [
