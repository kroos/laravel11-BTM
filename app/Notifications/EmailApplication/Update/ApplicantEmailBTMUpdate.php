...
namespace App\Notifications\EmailApplication\Update;
...
class ApplicantEmailBTMUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM01) Updated Application of Email Account For Approval')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->name . ',')
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.', has updated a request for a new email registration. The details of the application are available in the system for your review.')
