...
class ApplicantEmailBTMUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			...
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.' application, has been given an approval on a request for an email registration by '.Staff::find($this->data->approver_staff)->nama.'. The details of the application are available in the system for your review.')
