...
class ApplicantEmailDelete extends Notification
{
	use Queueable;
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM01) Deleted Application of Email Account')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->name . ',')
			->line('We hope this email finds you well.')
			->line('We would like to inform that your application is currently being deleted.')
