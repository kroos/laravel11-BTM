...
class ApplicantEmailApproverUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			...
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.' application, has been given an approval by '.Staff::find($this->data->btm_approver)->nama.' on a request for an email registration.')
			->line('The details of the application are available in the system for your review.')
			->line('Please find the attached PDF form for your reference. Kindly log into the system to access the request and provide your approval or rejection based on your discretion.')
			->line('You have the authority to approve or decline this application as you see fit.')
