...
namespace App\Notifications\EmailApplication\Create;
...
// class ApplicantEmailBTMCreate extends Notification implements ShouldQueue
class ApplicantEmailBTMCreate extends Notification
{
	use Queueable;
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM01) New Application of Email Account For Approval')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->name . ',')
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.', has submitted a request for a new email registration. The details of the application are available in the system for your review.')
