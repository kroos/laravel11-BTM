...
// class ApplicantEmailCreate extends Notification implements ShouldQueue
class ApplicantEmailCreate extends Notification
{
	use Queueable;
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM01) New Application of Email Account')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->name . ',')
			->line('We hope this email finds you well.')
			->line('We would like to inform that your application is currently being processed.')
