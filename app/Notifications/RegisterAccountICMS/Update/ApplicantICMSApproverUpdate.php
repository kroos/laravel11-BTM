...
class ApplicantICMSApproverUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM02) Updated Application of Account & ICMS Modules For Approval')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->nama . ',')
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.', has updated a request for a account & ICMS modules. The details of the application are available in the system for your review.')
