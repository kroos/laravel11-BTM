...
class ApplicantICMSBTMUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			...
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.' application, has been given an approval on a request for account & ICMS modules by '.Staff::find($this->data->btm_approver)->nama.'.')
