...
class ApplicantICMSUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM02) Approval Application of Account & ICMS Modules')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->nama . ',')
			->line('We hope this email finds you well.')
			->line('We would like to inform that your application is currently been given approval by '.Staff::find($this->data->approver_staff)->nama.'.')
