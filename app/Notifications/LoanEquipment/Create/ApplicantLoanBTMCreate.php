...
namespace App\Notifications\LoanEquipment\Create;
...
class ApplicantLoanBTMCreate extends Notification
{
	use Queueable;
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			->subject('BTM : (BTM03) New Application of Loan Equipment For Approval')
			->greeting('BTMgo')
			->line('Dear ' . $notifiable->name . ',')
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.', has submitted a request for a new loan equipment. The details of the application are available in the system for your review.')
