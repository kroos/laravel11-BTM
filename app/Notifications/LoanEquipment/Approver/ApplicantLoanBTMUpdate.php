...
namespace App\Notifications\LoanEquipment\Approver;
...
class ApplicantLoanBTMUpdate extends Notification
{
	use Queueable;
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			...
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.' application, has been given an approval on a request for loan equipment by '.Staff::find($this->data->approver_staff)->nama.'. The details of the application are available in the system for your review.')
