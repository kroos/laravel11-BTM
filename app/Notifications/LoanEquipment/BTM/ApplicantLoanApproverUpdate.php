...
class ApplicantLoanApproverUpdate extends Notification
{
	...
	public function toMail(object $notifiable): MailMessage
	{
		return (new MailMessage)
			...
			->line('This is to inform you that '.Staff::find($this->data->nostaf)->nama.' application, has been given an approval by '.Staff::find($this->data->btm_approver)->nama.' on a request for a loan equipment.')
